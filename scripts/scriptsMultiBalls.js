...
//					for(var k = 0; k < physics.ball_overlay.length; k++){
			...
			audio.bounce_res = gapi.hangout.av.effects.createAudioResource(baseUrl + "audio/teabag.wav");
			audio.fan_song_res = gapi.hangout.av.effects.createAudioResource(baseUrl + "audio/teaRoom.wav");
